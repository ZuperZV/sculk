...
@Mod("sculk")
public class SculkMod {
	public static final Logger LOGGER = LogManager.getLogger(SculkMod.class);
	public static final String MODID = "sculk";
	...
	public SculkMod() {
		...
		SculkModBlocks.REGISTRY.register(bus);
